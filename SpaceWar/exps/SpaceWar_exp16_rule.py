...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter(r"result/Exp16Graph/", sess.graph)
    ...
    checkpoint = tf.train.get_checkpoint_state(r"result/Exp16_saved_networks")
    ...
    while True:
        ...
        if t % 10000 == 0:
            saver.save(sess, 'result/Exp16_saved_networks/' + GAME + '-dqn', global_step=t)
