...
# import copy
# import gym
import spacecrash_game as game
import RuleAction
...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter(r"Exp04-rule-0.8/TensorboardGraph/", sess.graph)
    ...
    checkpoint = tf.train.get_checkpoint_state(r"Exp04-rule-0.8\saved_networks")
    #
    ...
    while True:
        ...
        if t % 10000 == 0:
            saver.save(sess, 'saved_networks/' + GAME + '-dqn-rule', global_step=t)
        ...
        print("TIMESTEP", t, "/ STATE", state,
              "/ EPSILON", epsilon, "/ OMEGA", omega, "/ ACTION", action_index, "/ REWARD", r_t,
