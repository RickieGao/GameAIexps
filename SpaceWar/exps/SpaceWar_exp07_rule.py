...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter(r"Exp07-rule-0.5/Exp07Graph/", sess.graph)
    ...
    checkpoint = tf.train.get_checkpoint_state("Exp07-rule-0.5/Exp07_saved_networks")
    ...
    while True:
        ...
        if t % 10000 == 0:
            saver.save(sess, 'Exp07-rule-0.5/Exp07_saved_networks/' + GAME + '-dqn', global_step=t)
