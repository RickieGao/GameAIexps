...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter(r"Exp05-DQN/Exp05_Graph/", sess.graph)
    ...
    checkpoint = tf.train.get_checkpoint_state("Exp05-DQN/Exp05_saved_networks")
    #
    ...
    while True:
        ...
        if t % 10000 == 0:
            saver.save(sess, 'Exp05-DQN/Exp05_saved_networks/' + GAME + '-dqn', global_step=t)
