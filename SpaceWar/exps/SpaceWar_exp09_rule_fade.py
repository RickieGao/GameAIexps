...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter(r"Exp09-rule-fade/Exp09Graph/", sess.graph)
    ...
    checkpoint = tf.train.get_checkpoint_state("Exp09-rule-fade/Exp09_saved_networks")
    ...
    while True:
        ...
        if t % 10000 == 0:
            saver.save(sess, 'Exp09-rule-fade/Exp09_saved_networks/' + GAME + '-dqn', global_step=t)
