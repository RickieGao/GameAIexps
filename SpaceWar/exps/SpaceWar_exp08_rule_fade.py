...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter(r"Exp08-rule-fade/Exp08Graph/", sess.graph)
    ...
    checkpoint = tf.train.get_checkpoint_state("Exp08-rule-fade/Exp08_saved_networks")
    ...
    while True:
        ...
        if t % 10000 == 0:
            saver.save(sess, 'Exp08-rule-fade/Exp08_saved_networks/' + GAME + '-dqn', global_step=t)
