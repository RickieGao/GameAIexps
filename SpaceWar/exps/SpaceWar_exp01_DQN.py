...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter(r"Exp01-DQN/Exp01_Graph/", sess.graph)
    ...
    checkpoint = tf.train.get_checkpoint_state("Exp01-DQN/Exp01_saved_networks")
    #
    ...
    while True:
        ...
        if t % 10000 == 0:
            saver.save(sess, 'Exp01-DQN/Exp01_saved_networks/' + GAME + '-dqn', global_step=t)
