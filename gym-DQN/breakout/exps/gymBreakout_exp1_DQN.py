...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    checkpoint = tf.train.get_checkpoint_state('saved_networks/Exp'+EXP_NUM+'_saved_networks' + GAME + '-dqn')
    ...
    while t < OBSERVE + EXPLORE + TRAINING:
        ...
        if t % 10000 == 0:
            saver.save(sess, 'saved_networks/Exp' + EXP_NUM + '_saved_networks' + GAME + '-dqn', global_step=t)
        ...
        print("TIMESTEP", t, "/ STATE", state,
              "/ EPSILON", epsilon, "/ REWARD", r_t, "/ EPISODE_REWARD", episode_reward, "/ TERMINAL", terminal)
        if terminal:
            episode_reward = 0
