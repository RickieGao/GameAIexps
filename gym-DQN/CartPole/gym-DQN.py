...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter(r"Exp-01-DQN/ExpGraph01/", sess.graph)
    ...
    with tf.name_scope('reward_per_10000_steps'):
        ...
        reward_sum_step = tf.summary.scalar('reward_per_10000 steps', reward_step)
    ...
    checkpoint = tf.train.get_checkpoint_state(r"Exp-01-DQN/Exp01_saved_networks")
    ...
    while True:
        ...
        x_t1_colored, r_t, terminal, _ = game.step(action_index)  # returns new game images and new reward.
        ...
        if t % 10000 == 0:
            saver.save(sess, 'Exp-01-DQN/Exp01_saved_networks/' + GAME + '-dqn', global_step=t)
