...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
	...
	writer = tf.summary.FileWriter("result/DQN_rule", sess.graph)
	...
	checkpoint = tf.train.get_checkpoint_state("result/DQN_rule_saved_networks")
	...
	while "flappy bird" != "angry bird":
		...
		if t % 10000 == 0:
			saver.save(sess, 'result/DQN_rule_saved_networks/' + GAME + '-dqn', global_step = t)
