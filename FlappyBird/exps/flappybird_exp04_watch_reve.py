...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
	...
	while t < 100000:
		...
		if rule_action == 'U' or rule_action == 'D':
			...
			if action_map[rule_action] == a_t.tolist():
				action_count += 1
			elif pic_num < 20 and t % 30 == 0:
				cv2.imwrite("reve" + str(t) + ".png", pygame_frame)
				pic_num += 1
	...
	action_times_array_file = open(r'\my_results\reve_action_times_array.txt', 'w')
