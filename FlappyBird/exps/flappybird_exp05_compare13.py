...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
	...
	checkpoint = tf.train.get_checkpoint_state("saved_networks/DQN_rule_reve_count_saved_networks")
	...
	while t < 100001:
		...
		if rule_action == 'U' or rule_action == 'D':
			rule_triger_times += 1
			np.save("image_data//reve_input_image//reve_input" + str(t) + rule_action + model_action + ".npy", s_t)
	...
	time_line_file = open(r'rate_result//rate_file//reve_time_line.txt', 'w')
	for word in time_line:
		time_line_file.write(str(word))
		time_line_file.write('\n')
	time_line_file.close()

	rate_array_file = open(r'rate_result//rate_file//reve_rate_array.txt', 'w')
	for word in rate_array:
		rate_array_file.write(str(word))
		rate_array_file.write('\n')
	rate_array_file.close()

	trigger_time_array_file = open(r'rate_result//rate_file//reve_trigger_time_array.txt', 'w')
	...
	action_times_array_file = open(r'rate_result//rate_file//reve_action_times_array.txt', 'w')
