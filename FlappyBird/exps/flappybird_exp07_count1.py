...
from image_processing_3 import *
...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
	...
	while t < 100001:
		...
		if rule_action == 'U' or rule_action == 'D':
			rule_triger_times += 1
			np.save("image_data//exp7_3_input_image//dqn_input" + str(t) + rule_action + model_action + ".npy", s_t)
		...
		print("TIMESTEP", t, "/ RULE_ACTION", rule_action, '/ TRIGER:', rule_triger_times, '/ ACTION COUNT:', action_count)

	print('/ TRIGER:', rule_triger_times, '/ ACTION COUNT:', action_count)
	print('finished!')
