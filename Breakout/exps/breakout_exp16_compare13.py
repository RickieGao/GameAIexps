...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
	...
	do_nothing[1] = 1
	x_t_colored, r_0, terminal, ball_x, bat_x = game_state.frame_step(do_nothing)
	...
	checkpoint = tf.train.get_checkpoint_state("saved_networks/Exp11_saved_networks")
	...
	while t < 100001:
		...
		x_t1_colored, r_t, terminal, ball_x, bat_x = game_state.frame_step(a_t)				# returns new game images and new reward.
		...
		print("TIMESTEP", t, "/ REWARD", r_t, "/ RULE_ACTION", rule_action, "/ MODEL_ACTION", model_action)

	print('rule action:', action_count)
	print('finished!')
