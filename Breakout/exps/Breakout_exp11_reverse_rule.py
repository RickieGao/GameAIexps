...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter(r"result/Exp11Graph/", sess.graph)
    ...
    do_nothing[1] = 1
    x_t_colored, r_0, terminal, ball_x, bat_mid = game_state.frame_step(do_nothing)
    ...
    checkpoint = tf.train.get_checkpoint_state(r"result/Exp11_saved_networks")
    ...
    while True:
        ...
        if t % 10000 == 0:
            saver.save(sess, 'result/Exp11_saved_networks/' + GAME + '-dqn', global_step=t)
