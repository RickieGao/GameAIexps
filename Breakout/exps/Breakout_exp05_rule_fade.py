...
START_INTERVENE = 0  # timesteps to start intervene
...
INITIAL_PROBABILITY = 0  # starting value of probability of human choose
FINAL_PROBABILITY = 0.5  # final value of probability of human choose
...
def trainNetwork(s, readout, h_fc1, sess):
    ...
    while t <= OBSERVE + EXPLORE + TRAINING:
        ...
        if t % FRAME_PER_ACTION == 0:
            ...
            if random.random() <= probability and t > OBSERVE + START_INTERVENE:
                print("----------Human Action----------")
                if ball_x < bat_mid:
        ...
        if probability < FINAL_PROBABILITY and t > OBSERVE:
            probability += (FINAL_PROBABILITY - INITIAL_PROBABILITY) / (TRAINING + EXPLORE)
    ...
    plt.xlabel("episode")
    plt.ylabel("reward")
    plt.title("reward per episode change")
