...
def trainNetwork(s, readout, h_fc1, sess):
    ...
    while t <= OBSERVE + EXPLORE + TRAINING:
        ...
        x_t1_colored, r_t, terminal, ball_x, bat_mid = game_state.frame_step(a_t)
