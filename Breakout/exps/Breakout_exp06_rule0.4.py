...
FRAME_PER_ACTION = 1
PROBABILITY = 0.4  # probability of human choose
...
def trainNetwork(s, readout, h_fc1, sess):
    ...
    plt.xlabel("episode")
    plt.ylabel("reward")
    plt.title("reward per 100 episode change")
