...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter("Exp-03-avoidTreeRule-0.5/tensorboardgraph/", sess.graph)
    ...
    checkpoint = tf.train.get_checkpoint_state("Exp-03-avoidTreeRule-0.5/saved_networks")
    #
    ...
    while True:
        ...
        if t % 10000 == 0:
            saver.save(sess, 'Exp-03-avoidTreeRule-0.5/saved_networks/' + GAME + '-dqn', global_step=t)
