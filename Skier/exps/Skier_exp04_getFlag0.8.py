...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter("Exp-04-getFlagRule-0.8/tensorboardgraph/", sess.graph)
    ...
    checkpoint = tf.train.get_checkpoint_state("Exp-04-getFlagRule-0.8/saved_networks")
    #
