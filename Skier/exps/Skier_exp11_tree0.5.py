...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter(r"Exp11-avoidTree-0.5/ExpGraph11/", sess.graph)
    ...
    checkpoint = tf.train.get_checkpoint_state("Exp11-avoidTree-0.5/Exp11_saved_networks")
    ...
    while True:
        ...
        if t % 10000 == 0:
            saver.save(sess, r'Exp11-avoidTree-0.5/Exp11_saved_networks/' + GAME + '-dqn', global_step=t)
