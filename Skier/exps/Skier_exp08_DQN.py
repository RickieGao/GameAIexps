...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter(r"Exp-08-DQN/ExpGraph08/", sess.graph)
    ...
    checkpoint = tf.train.get_checkpoint_state(r"Exp-08-DQN/Exp08_saved_networks")
    #
    ...
    while True:
        ...
        if t % 10000 == 0:
            saver.save(sess, 'Exp-08-DQN/Exp08_saved_networks/' + GAME + '-dqn', global_step=t)
