...
def trainNetwork(s, readout, W_fc1, W_fc2, sess):
    ...
    writer = tf.summary.FileWriter("Exp-05-getFlagRule-0.5-0/tensorboardgraph/", sess.graph)
    ...
    checkpoint = tf.train.get_checkpoint_state("Exp-05-getFlagRule-0.5-0/saved_networks")
    #
